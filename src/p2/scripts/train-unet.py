...
X_tensor, y_tensor = load_images_and_masks_tensors(
    os.path.join(os.path.dirname(__file__), '..', 'data', 'resized', 'CameraRGB'), 
    os.path.join(os.path.dirname(__file__), '..', 'data', 'resized', 'CameraMask')
)
...
model.save(os.path.join(os.path.dirname(__file__), '..', 'models', 'unet_model.h5'))